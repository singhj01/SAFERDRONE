...
def Front(message):
   ...
   temp[2] = binascii.unhexlify('6c')#64 0b
   temp[3] = binascii.unhexlify('18')
   return "".join(temp)
...
def Left(message):
   #print ("left")
   temp = list(str(message))
   temp[1] = binascii.unhexlify('fa') #94 06
   temp[2] = binascii.unhexlify('05')
   return "".join(temp)
...
def Rear(message):
   #print ("Rear")
   temp = list(str(message))
   temp[2] = binascii.unhexlify('9c') #a4 34
...
def Right(message):
   #print ("Right")
   temp = list(message)
   temp[1] = binascii.unhexlify('f9') #bc 01
